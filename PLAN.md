...
- [ ] `src/views/groupsTreeProvider.ts` (EventEmitter refresh pattern)
- [ ] `contributes.commands`, `contributes.menus` wiring
- [ ] Manual F5 smoke: apply Apex, apply Lightning, create custom, edit, delete
