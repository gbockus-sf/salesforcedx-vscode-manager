...
- **Total repository** (all non-merge commits, excluding `package-lock.json`): **+8,721 / −731 lines (net +7,990)**.
- **Total commits**: 38 on `main` (including 3 merges).
- **Tests**: **179 passing** across 17 suites.
- **Packaged VSIX**: 16 files, ~40 KB.
